...
.controller('ReportsListInverfactCtrl', function($scope, $log, $filter, $window, $timeout, $uibModal, $sce, NgTableParams, Reports, Utils) {
	...
	for (i = 0; i < $scope.columns.length; i++) {
		...
		$scope.filter.include = 'images,pdfs,state';//_.findWhere(_.findWhere(included, { name: 'Reportes'}).items, { path: 'echeckit.reports.list'}).included;
